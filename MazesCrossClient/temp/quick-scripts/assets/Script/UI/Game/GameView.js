(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/UI/Game/GameView.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '3a5f4xh9CRAI6wc4y+upnjw', 'GameView', __filename);
// Script/UI/Game/GameView.js
    ...
    createGrid: function createGrid(_levelDimensions, walls, ices, towers, cb) {
        ...
        for (var i = 0; i < this.levelDimensions.x; i++) {
            for (var j = 0; j < this.levelDimensions.y; j++) {
                ...
                var self = this;
                if (j % 2 == 0) {
                    hexTile.runAction(cc.sequence(cc.moveTo(0.2 + 0.05 * axialPoint.y, screenPoint.x, screenPoint.y), cc.callFunc(function () {
