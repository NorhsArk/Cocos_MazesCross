(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/SDK/facebook.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '6542a5UC9RCqLxrtQE6lpYc', 'facebook', __filename);
...
FB_SDK.prototype.setItem = function (param, cb) {
    if (typeof FBInstant === 'undefined') {
        ...
        FBInstant.player.setDataAsync(param).then(function () {
            if (cb != null) {
                cb();
            }
...
FB_SDK.prototype.getPercent = function (cb) {
    if (typeof FBInstant === 'undefined') {
        ...
        FBInstant.getLeaderboardAsync('World').then(function (leaderboard) {
